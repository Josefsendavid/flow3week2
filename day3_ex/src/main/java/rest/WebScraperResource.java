...
public class WebScraperResource {
    ...
    @GET
    @Produces(MediaType.APPLICATION_JSON)
    public List<TagDTO> getTagsParrallel() throws ExecutionException, InterruptedException {
        long startTime = System.nanoTime();
        List<TagDTO> result = Tester.runParrallel();
        long endTime = System.nanoTime()-startTime;
        return result;//("Parrallel fetching", result, endTime);
    }
